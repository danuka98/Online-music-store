...
public class mostPopular extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//Create a SQL query to insert data into mostpopular table.
			PreparedStatement stmt = con.prepareStatement("INSERT INTO mostpopular VALUES (0,?,?,?,?)");
			...
			if(rs>0) {
				...
				response.getWriter().println("upload is not complete");
			}
		}catch(Exception e){
			e.printStackTrace();
		}
