...
@WebServlet("/ImageRetrivingServlet5")
public class ImageRetrivingServlet5 extends HttpServlet {
	...
	protected void service(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try {
			...
			String sql = "SELECT uploadPhoto FROM trendingsong WHERE trendingID = 9";
